...
call %VUFIND_HOME%\import\index-alphabetic-browse.bat build_browse title title_fullStr 1 VuFindTitleLeech
call %VUFIND_HOME%\import\index-alphabetic-browse.bat build_browse topic topic_browse
call %VUFIND_HOME%\import\index-alphabetic-browse.bat build_browse author author_browse
goto end
