...
NS.LANG.en = {
    ...
    'label' : {
        ...
        'contrastInvert' : 'minder contrast',
        ...
        'narrowscreen' : 'compact scherm',
        'share' : 'embedden',
        'print' : 'downloaden/printen',
...
'8. Het IISG accepteert geen verantwoordelijkheid voor hoe het materiaal gebruikt wordt. </div>'
        }
    },
    help : {
        modal : {
...
'2. de tweede werkbalk toont links icoontjes om het beeld aan te passen (zoomen, contrast, draaien). Aan de rechterkant zijn icoontjes om bijbehorende tekst te bekijken (als die er is), het thumbnail overzicht te bekijken of terug te gaan naar het compacte scherm.<br />' +
'3. de werkbalk onderaan toont permanente links voor het plaatje en de beschrijving. Aan de rechterkant staan de extra opties: embedden, downloaden, copyrights en helpscherm.</div>'
        }
    }
};
